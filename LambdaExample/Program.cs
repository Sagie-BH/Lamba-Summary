...
namespace LinqMethods
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            ///FindAll() is a function on the List<T> type,
            ///it's not a LINQ extension method like Where.
            ///The LINQ extension methods work on any type that implements IEnumerable
            ///Whereas FindAll can only be used on List<T> instances (or instances of classes that inherit from it, of course)
            ///
            ///Find all e(object from listPersonsInCity)
            /// => - go to operator/function
            /// property Age of e(person object) >= 60
            /// Tolist - to able for each loop for printing
            ...
            ///or whether any element of a sequence satisfies a condition
            ///returns a boolean  (true / flase)

            ///           Any     <TSource>     (IEnumerable<TSource>   , Func<TSource,Boolean>)
            ///                 e(person objet)   =>        e.Age >= 13  && e.Age <= 19
            ...
            ///Exsist - Determines whether the specified file exists. 
            ///returns a boolean  (true / flase)

            ///Doesn't belong to linq
            ...
            /// FindIndex - Searches for an element that matches the conditions defined by a specified predicate
            /// and returns the zero-based index of the first occurrence within an Array or a portion of it.
